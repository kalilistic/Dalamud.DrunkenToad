...
namespace Dalamud.DrunkenToad
{
    ...
    public class PluginService
    {
        ...
        public PluginService(string pluginName, DalamudPluginInterface pluginInterface)
        {
        ...
        /// <summary>
        /// Gets backup manager for litedb.
        /// </summary>
        ...
        /// <summary>
        /// Returns indicator if player is in high-end duty.
        /// </summary>
        /// <returns>indicator if in high-end duty.</returns>
        public bool InHighEndDuty()
        {
            try
            {
                var territoryTypeId = this.ClientState.TerritoryType();
                ...
                var contentId = this.GameData.ContentId(territoryTypeId);
                return contentId != 0 && this.GameData.IsHighEndDuty(contentId);
            }
            catch
            {
                return false;
